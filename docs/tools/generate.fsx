...
let website = "/ExtEngine"

let githubLink = "http://github.com/MallabaevAzamat/ExtEngine"

// Specify more information about your project
let info =
  [ "project-name", "ExtEngine"
    "project-author", "Fenex9428 (Mallabaev Azamat)"
    "project-summary", "small core for extensible project, similary for electron (base of atom-editor), but constructed on .net platform"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/ExtEngine" ]
